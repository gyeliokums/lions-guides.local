<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-06-21 14:29:59
         compiled from ".\templates\guest\country.tpl" */ ?>
<?php /*%%SmartyHeaderCode:30864552f75f67ab959-22436843%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3d4843b4b5bb2fd589a50670d30421951e3b4a38' => 
    array (
  ...
  'nocache_hash' => '30864552f75f67ab959-22436843',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_552f75f6a3bdf5_13583692',
  'variables' => 
  array (
    '_page_title' => 0,
    '_page_keywords' => 0,
...
<?php if ($_valid && !is_callable('content_552f75f6a3bdf5_13583692')) {function content_552f75f6a3bdf5_13583692($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="ru">
	<head>
		<meta charset="utf-8">
...
<link href="/css/jquery.bxslider.css" rel="stylesheet" type="text/css" />
	...
	<div class="page">
		<h1><?php echo $_smarty_tpl->tpl_vars['data']->value['country']['data']['name'];?>
</h1>
 ...
 $_from = $_smarty_tpl->tpl_vars['data']->value['country']['data']['lions']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['lion']->key => $_smarty_tpl->tpl_vars['lion']->value) {
$_smarty_tpl->tpl_vars['lion']->_loop = true;
?>
				<li><a href="<?php echo $_smarty_tpl->tpl_vars['lion']->value['link'];?>
"><?php echo $_smarty_tpl->tpl_vars['lion']->value['name'];?>
</a></li>
				<?php } ?>
			</ul>
		</div> 
 ...
 $_from = $_smarty_tpl->tpl_vars['data']->value['country']['data']['guides']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['guide']->key => $_smarty_tpl->tpl_vars['guide']->value) {
$_smarty_tpl->tpl_vars['guide']->_loop = true;
?>
				<li><a href="<?php echo $_smarty_tpl->tpl_vars['guide']->value['link'];?>
"><?php echo $_smarty_tpl->tpl_vars['guide']->value['name'];?>
</a></li>
				<?php } ?>
			</ul>
		</div> 
		<?php echo $_smarty_tpl->tpl_vars['data']->value['country']['data']['description'];?>
...
">Далее</a></p>
 ...
 $_from = $_smarty_tpl->tpl_vars['data']->value['cities']['data']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['city']->key => $_smarty_tpl->tpl_vars['city']->value) {
$_smarty_tpl->tpl_vars['city']->_loop = true;
?>
					<li><a href="/<?php echo $_smarty_tpl->tpl_vars['city']->value['inner_name'];?>
"><span><?php echo $_smarty_tpl->tpl_vars['city']->value['name'];?>
</span><img src="/uploads/images/stateunion/<?php echo $_smarty_tpl->tpl_vars['city']->value['union_id'];?>
/country/<?php echo $_smarty_tpl->tpl_vars['city']->value['country_id'];?>
/city/<?php echo $_smarty_tpl->tpl_vars['city']->value['city_id'];?>
/<?php echo $_smarty_tpl->tpl_vars['city']->value['image'];?>
" style="width: 150px;" /></a></li>
					<?php } ?>
				</ul>
			</div>
			<a href="javascript:void(0);" rel="nofollow" class="baner" style="cursor: default;"><img src="/images/728-90-2.jpg" alt="" /></a>
