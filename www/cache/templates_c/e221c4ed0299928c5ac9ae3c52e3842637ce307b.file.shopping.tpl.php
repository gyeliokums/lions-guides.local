<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-05-01 12:45:01
         compiled from ".\templates\guest\shopping.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20645552e6a2db2bd71-23905527%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e221c4ed0299928c5ac9ae3c52e3842637ce307b' => 
    array (
  ...
  'nocache_hash' => '20645552e6a2db2bd71-23905527',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_552e6a2ddd7798_32167341',
  'variables' => 
  array (
    '_page_title' => 0,
    '_page_keywords' => 0,
...
<?php if ($_valid && !is_callable('content_552e6a2ddd7798_32167341')) {function content_552e6a2ddd7798_32167341($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="ru">
	<head>
		<meta charset="utf-8">
...
<link href="/css/jquery.bxslider.css" rel="stylesheet" type="text/css" />
	...
	<div class="page">
		<h1><?php echo $_smarty_tpl->tpl_vars['data']->value['shopping']['data']['name'];?>
</h1>
		<?php echo $_smarty_tpl->tpl_vars['breadcrumbs']->value;?>

		<?php echo $_smarty_tpl->tpl_vars['data']->value['shopping']['data']['description'];?>
...
" title="Поделиться в ВКонтакте"><img src="/images/soc/VK.png" alt="Поделиться в Facebook" style="width: 32px;" /></a>
...
" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><img src="/images/soc/G.png" alt="Поделиться в Google+" style="width: 32px;" /></a>
				<a target="_blank" re="nofollow" href="http://www.twitter.com/share?url=http://lions-guides.ru/<?php echo $_smarty_tpl->tpl_vars['_inner_name']->value;?>
&amp;text=<?php if ($_smarty_tpl->tpl_vars['_page_title']->value) {
echo $_smarty_tpl->tpl_vars['_page_title']->value;
} else { ?>Путеводители по городам и странам. Описание достопримечательностей.<?php }?>" title="Поделиться в Facebook"><img src="/images/soc/Twitter.png" alt="Поделиться в Facebook" style="width: 32px;" /></a>
			</div>
		</div>
	</div> 
