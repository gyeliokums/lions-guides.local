<?php /*%%SmartyHeaderCode:2529055a0bf758b7103-42012787%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2529055a0bf758b7103-42012787',
  'variables' => 
  array (
    '_page_title' => 0,
    '_page_keywords' => 0,
  ...
  'unifunc' => 'content_55a0bf76bdc059_64894784',
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a0bf76bdc059_64894784')) {function content_55a0bf76bdc059_64894784($_smarty_tpl) {?>
<!DOCTYPE html>
	...
	<div id="page-wrapper">
		...
		<div class="container">
			<div class="page-title pull-left">
				<h1 class="entry-title">Где провести отпуск</h2>
			</div>
	...
	<section id="content">
		<div class="container">
						...
						<div id="main" class="md-section">
								<h2 id="Russia" name="Russia" class="no-margin">Россия</h2>
				<div class="small-box"></div>
				<div class="row image-box style1 add-clearfix">
																<div class="col-sm-6 col-md-3">
						<article class="box country">
							<div class="details">
								<a  title="Татарстан" href="/Tatarstan">
									<h4 class="box-title">Татарстан</h4>
								</a>
							</div>
						</article>
					</div>
						...
						<article class="box country">
							<div class="details">
								<a  title="Алтайский край" href="/Altai-Krai">
									<h4 class="box-title">Алтайский край</h4>
								</a>
							</div>
						</article>
					</div>
						...
						<article class="box country">
							<div class="details">
								<a  title="Костромская область" href="/Kostroma-region">
									<h4 class="box-title">Костромская область</h4>
								</a>
							</div>
						</article>
					</div>
						...
						<article class="box country">
							<div class="details">
								<a  title="Краснодарский край" href="/Krasnodar-krai">
									<h4 class="box-title">Краснодарский край</h4>
								</a>
							</div>
						</article>
					</div>
						...
						<article class="box country">
							<div class="details">
								<a  title="Крым" href="/Crimea">
									<h4 class="box-title">Крым</h4>
								</a>
							</div>
						</article>
					</div>
						...
						<article class="box country">
							<div class="details">
								<a  title="Самарская область" href="/Samara-region">
									<h4 class="box-title">Самарская область</h4>
								</a>
							</div>
						</article>
					</div>
						...
						<article class="box country">
							<div class="details">
								<a  title="Ярославская область" href="/Yaroslavl-region">
									<h4 class="box-title">Ярославская область</h4>
								</a>
							</div>
						</article>
					</div>
															</div>
																<h2 id="Europe" name="Europe" class="no-margin">Европа</h2>
				<div class="small-box"></div>
				<div class="row image-box style1 add-clearfix">
																<div class="col-sm-6 col-md-3">
						<article class="box country">
							<div class="details">
								<a  title="Италия" href="/Italy">
									<h4 class="box-title">Италия</h4>
								</a>
							</div>
						</article>
					</div>
						...
						<article class="box country">
							<div class="details">
								<a  title="Латвия" href="/Latvia">
									<h4 class="box-title">Латвия</h4>
								</a>
							</div>
						</article>
					</div>
						...
						<article class="box country">
							<div class="details">
								<a  title="Республика Беларусь" href="/Belarus">
									<h4 class="box-title">Республика Беларусь</h4>
								</a>
							</div>
						</article>
					</div>
						...
						<article class="box country">
							<div class="details">
								<a  title="Чехия" href="/Czech-Republic">
									<h4 class="box-title">Чехия</h4>
								</a>
							</div>
						</article>
					</div>
																		...
																		<div class="container">
					<div class="row">
						<a href="http://test.lions-guides.ru/" target="_blank" rel="nofollow">
							<img src="http://test.lions-guides.ru/uploads/banners/1.jpg" alt="Bash.org.ru" width="1170" height="160" />
						</a>
					</div>
				</div>
																					<h2 id="Africa" name="Africa" class="no-margin">Африка</h2>
				<div class="small-box"></div>
				<div class="row image-box style1 add-clearfix">
																<div class="col-sm-6 col-md-3">
						<article class="box country">
							<div class="details">
								<a  title="Египет" href="/Egypt">
									<h4 class="box-title">Египет</h4>
								</a>
							</div>
						</article>
					</div>
															</div>
																<h2 id="Asia" name="Asia" class="no-margin">Азия</h2>
				<div class="small-box"></div>
				<div class="row image-box style1 add-clearfix">
																<div class="col-sm-6 col-md-3">
						<article class="box country">
							<div class="details">
								<a  title="Израиль" href="/Israel">
									<h4 class="box-title">Израиль</h4>
								</a>
							</div>
						</article>
					</div>
						...
						<article class="box country">
							<div class="details">
								<a  title="Турция" href="/Turkey">
									<h4 class="box-title">Турция</h4>
								</a>
							</div>
						</article>
					</div>
					...
					<div class="row">
						<a href="http://test.lions-guides.ru/" target="_blank" rel="nofollow">
							<img src="http://test.lions-guides.ru/uploads/banners/2.jpg" alt="Govnokod.ru" width="1170" height="160" />
						</a>
					</div>
				</div>
																					<h2 id="America" name="America" class="no-margin">Америка</h2>
				<div class="small-box"></div>
				<div class="row image-box style1 add-clearfix">
																<div class="col-sm-6 col-md-3">
						<article class="box country">
