<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-06-10 16:09:52
         compiled from ".\templates\administrator\article.list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:30073552df80fd52dd6-63724800%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2a17cf8b733a8ecd59cc8957a1a3c4886e151988' => 
    array (
      0 => '.\\templates\\administrator\\article.list.tpl',
      1 => 1431875666,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '30073552df80fd52dd6-63724800',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_552df80fe12486_26227862',
  'variables' => 
  array (
    'data' => 0,
    'htmlForm' => 0,
...
<?php if ($_valid && !is_callable('content_552df80fe12486_26227862')) {function content_552df80fe12486_26227862($_smarty_tpl) {?><!DOCTYPE html>
<html lang="ru">
<head>
        <meta charset="utf-8">
...
">Города</a></li>
			<li class="active"><a href="?model=article&amp;parent_id=<?php echo $_smarty_tpl->tpl_vars['data']->value['common']['parent_id'];?>
">Статьи</a></li>
...
">Баннеры</a></li>
	...
	<div class="panel-body">
		<a href="?model=article&amp;action=add&amp;parent_id=<?php echo $_smarty_tpl->tpl_vars['data']->value['common']['parent_id'];?>
">Добавить статью</a>
		<table class="table">
			<thead>
			<tr>
...
&amp;back">&uArr; Вернуться к странам &uArr;</a></td>
 ...
 $_from = $_smarty_tpl->tpl_vars['data']->value['article']['data']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['article']->key => $_smarty_tpl->tpl_vars['article']->value) {
$_smarty_tpl->tpl_vars['article']->_loop = true;
?>
				<tr>
					<td><?php echo $_smarty_tpl->tpl_vars['article']->value['inner_name'];?>
</td>
					<td><?php echo $_smarty_tpl->tpl_vars['article']->value['name'];?>
</td>
					<td><a href="?model=article&amp;action=update&amp;id=<?php echo $_smarty_tpl->tpl_vars['article']->value['id'];?>
">Изменить</a></td>
					<td><a href="?model=article&amp;id=<?php echo $_smarty_tpl->tpl_vars['article']->value['id'];?>
&amp;parent_id=<?php echo $_smarty_tpl->tpl_vars['article']->value['parent_id'];?>
