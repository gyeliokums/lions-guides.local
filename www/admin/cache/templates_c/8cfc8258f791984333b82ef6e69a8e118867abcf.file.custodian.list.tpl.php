<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-06-02 10:02:57
         compiled from ".\templates\administrator\custodian.list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:36055289ce9f01145-31928421%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8cfc8258f791984333b82ef6e69a8e118867abcf' => 
    array (
      0 => '.\\templates\\administrator\\custodian.list.tpl',
      1 => 1427966880,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '36055289ce9f01145-31928421',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_55289cea0b4ef4_20924171',
  'variables' => 
  array (
    'data' => 0,
    'htmlForm' => 0,
...
<?php if ($_valid && !is_callable('content_55289cea0b4ef4_20924171')) {function content_55289cea0b4ef4_20924171($_smarty_tpl) {?><!DOCTYPE html>
<html lang="ru">
<head>
        <meta charset="utf-8">
...
<section>
	...
	<form class="form-horizontal" role="form" action="?model=custodian&amp;save&amp;submit=save" method="post" enctype="multipart/form-data">
		<div class="form-group">
			...
			<div class="col-lg-10">
				<input type="text" class="form-control" id="fileName" name="fileName" placeholder="Имя файла для сохранения" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['custodian']['fileName'];?>
" />
			</div>
		</div>
		<hr />
 ...
 $_from = $_smarty_tpl->tpl_vars['data']->value['custodian']['fileList']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
