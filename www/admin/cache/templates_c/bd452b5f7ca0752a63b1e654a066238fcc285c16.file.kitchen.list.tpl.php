<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-07-05 16:23:50
         compiled from ".\templates\administrator\kitchen.list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2535555993df61d58b6-82583879%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bd452b5f7ca0752a63b1e654a066238fcc285c16' => 
    array (
      0 => '.\\templates\\administrator\\kitchen.list.tpl',
      1 => 1431875596,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2535555993df61d58b6-82583879',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55993df6a0f223_17222220',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55993df6a0f223_17222220')) {function content_55993df6a0f223_17222220($_smarty_tpl) {?><!DOCTYPE html>
<html lang="ru">
<head>
        <meta charset="utf-8">
...
">Путеводители</a></li>
			<li class="active"><a href="?model=kitchen&amp;parent_id=<?php echo $_smarty_tpl->tpl_vars['data']->value['common']['parent_id'];?>
">Кухня</a></li>
...
&amp;back">&uArr; Вернуться к странам &uArr;</a></td>
			...
			<?php  $_smarty_tpl->tpl_vars['kitchen'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['kitchen']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['data']->value['kitchen']['data']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['kitchen']->key => $_smarty_tpl->tpl_vars['kitchen']->value) {
$_smarty_tpl->tpl_vars['kitchen']->_loop = true;
?>
				<tr>
					<td><?php echo $_smarty_tpl->tpl_vars['kitchen']->value['inner_name'];?>
</td>
					<td><?php echo $_smarty_tpl->tpl_vars['kitchen']->value['name'];?>
</td>
					<td><a href="?model=kitchen&amp;action=update&amp;id=<?php echo $_smarty_tpl->tpl_vars['kitchen']->value['id'];?>
">Изменить</a></td>
					<td><a href="?model=kitchen&amp;id=<?php echo $_smarty_tpl->tpl_vars['kitchen']->value['id'];?>
&amp;parent_id=<?php echo $_smarty_tpl->tpl_vars['kitchen']->value['parent_id'];?>
