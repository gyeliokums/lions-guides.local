<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-06-10 16:09:54
         compiled from ".\templates\administrator\article.item.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1198855784532cb2052-85231517%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '69155212b295e2d32c4a339d62df5b3bb1e66087' => 
    array (
      0 => '.\\templates\\administrator\\article.item.tpl',
      1 => 1433849742,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1198855784532cb2052-85231517',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55784532dd31a5_23620105',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55784532dd31a5_23620105')) {function content_55784532dd31a5_23620105($_smarty_tpl) {?><!DOCTYPE html>
<html lang="ru">
<head>
        <meta charset="utf-8">
...
" />
		<?php } else { ?>
		<input type="hidden" name="parent_id" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['article']['data']['parent_id'];?>
" />
		<?php }?>
		<div class="form-group">
			<label for="inner_name" class="col-lg-2 col-sm-2 control-label">Внутреннее имя (URL)</label>
			<div class="col-lg-10">
				<input type="text" class="form-control" id="inner_name" name="inner_name" placeholder="Внутреннее имя" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['article']['data']['inner_name'];?>
" required />
				...
				<div class="panel">
					...
					<div id="collapseSEO" class="panel-collapse collapse">
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" id="title" name="title" placeholder="Заголовок страницы (title)" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['article']['data']['title'];?>
" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" id="keywords" name="keywords" placeholder="Ключевые слова (keywords)" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['article']['data']['keywords'];?>
" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" id="meta_description" name="meta_description" placeholder="Описание страницы (meta description)" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['article']['data']['meta_description'];?>
" />
							</div>
						</div>
					</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-10">
				<input type="text" class="form-control" id="name" name="name" placeholder="Название статьи" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['article']['data']['name'];?>
" required />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-lg-10">
				<input type="text" class="form-control" id="short_description" name="short_description" placeholder="Короткое описание" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['article']['data']['short_description'];?>
" maxlength="60" required />
				<p class="help-block">Требуется для вывода в списке</p>
			</div>
		</div>
		<?php if ($_smarty_tpl->tpl_vars['data']->value['article']['data']['image']) {?>
		<div class="form-group">
...
/article/<?php echo $_smarty_tpl->tpl_vars['data']->value['common']['id'];?>
/<?php echo $_smarty_tpl->tpl_vars['data']->value['article']['data']['image'];?>
" target="_blank">
...
" width="150" />
						...
						<label><input type="checkbox" name="removeImage" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['article']['data']['image'];?>
" class="delImg" /> Удалить</label>
		...
		<div class="form-group">
			...
			<div class="col-lg-10">
				<textarea class="form-control" id="description" name="description" placeholder="Основной текст" rows="19"><?php echo $_smarty_tpl->tpl_vars['data']->value['article']['data']['description'];?>
</textarea>
			</div>
		</div>
...
echo $_smarty_tpl->tpl_vars['data']->value['article']['data']['parent_id'];
