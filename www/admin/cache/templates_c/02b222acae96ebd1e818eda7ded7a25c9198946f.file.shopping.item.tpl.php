<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-05-24 13:43:16
         compiled from ".\templates\administrator\shopping.item.tpl" */ ?>
<?php /*%%SmartyHeaderCode:29407552e66e3b94b03-48518019%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '02b222acae96ebd1e818eda7ded7a25c9198946f' => 
    array (
      0 => '.\\templates\\administrator\\shopping.item.tpl',
      1 => 1429075474,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '29407552e66e3b94b03-48518019',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_552e66e3cfc167_67284268',
  'variables' => 
  array (
    'data' => 0,
    'htmlForm' => 0,
...
<?php if ($_valid && !is_callable('content_552e66e3cfc167_67284268')) {function content_552e66e3cfc167_67284268($_smarty_tpl) {?><!DOCTYPE html>
<html lang="ru">
<head>
        <meta charset="utf-8">
...
" />
		<?php } else { ?>
		<input type="hidden" name="parent_id" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['shopping']['data']['parent_id'];?>
" />
		<?php }?>
		<div class="form-group">
			<label for="inner_name" class="col-lg-2 col-sm-2 control-label">Внутреннее имя (URL)</label>
			<div class="col-lg-10">
				<input type="text" class="form-control" id="inner_name" name="inner_name" placeholder="Внутреннее имя" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['shopping']['data']['inner_name'];?>
" required />
				...
				<div class="panel">
					...
					<div id="collapseSEO" class="panel-collapse collapse">
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" id="title" name="title" placeholder="Заголовок страницы (title)" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['shopping']['data']['title'];?>
" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" id="keywords" name="keywords" placeholder="Ключевые слова (keywords)" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['shopping']['data']['keywords'];?>
" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" id="meta_description" name="meta_description" placeholder="Описание страницы (meta description)" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['shopping']['data']['meta_description'];?>
" />
							</div>
						</div>
					</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-10">
				<input type="text" class="form-control" id="name" name="name" placeholder="Название статьи" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['shopping']['data']['name'];?>
" required />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-lg-10">
				<input type="text" class="form-control" id="short_description" name="short_description" placeholder="Короткое описание" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['shopping']['data']['short_description'];?>
" maxlength="60" required />
		...
		<div class="form-group">
			...
			<div class="col-lg-10">
				<textarea class="form-control" id="description" name="description" placeholder="Основной текст" rows="19"><?php echo $_smarty_tpl->tpl_vars['data']->value['shopping']['data']['description'];?>
</textarea>
			</div>
		</div>
...
echo $_smarty_tpl->tpl_vars['data']->value['shopping']['data']['parent_id'];
