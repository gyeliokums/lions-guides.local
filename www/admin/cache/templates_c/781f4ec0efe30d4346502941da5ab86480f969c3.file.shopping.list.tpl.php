<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-05-17 17:18:27
         compiled from ".\templates\administrator\shopping.list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17175552df836915c42-69617589%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '781f4ec0efe30d4346502941da5ab86480f969c3' => 
    array (
      0 => '.\\templates\\administrator\\shopping.list.tpl',
      1 => 1431875903,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '17175552df836915c42-69617589',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_552df8369e4cf0_94867231',
  'variables' => 
  array (
    'data' => 0,
    'htmlForm' => 0,
...
<?php if ($_valid && !is_callable('content_552df8369e4cf0_94867231')) {function content_552df8369e4cf0_94867231($_smarty_tpl) {?><!DOCTYPE html>
<html lang="ru">
<head>
        <meta charset="utf-8">
...
">Сувениры</a></li>
			<li class="active"><a href="?model=shopping&amp;parent_id=<?php echo $_smarty_tpl->tpl_vars['data']->value['common']['parent_id'];?>
">Шоппинг</a></li>
...
">Баннеры</a></li>
	...
	<div class="panel-body">
		<a href="?model=shopping&amp;action=add&amp;parent_id=<?php echo $_smarty_tpl->tpl_vars['data']->value['common']['parent_id'];?>
">Добавить статью</a>
		<table class="table">
			<thead>
			<tr>
...
?>
				<tr>
					<td><?php echo $_smarty_tpl->tpl_vars['shopping']->value['inner_name'];?>
</td>
					<td><?php echo $_smarty_tpl->tpl_vars['shopping']->value['name'];?>
</td>
					<td><a href="?model=shopping&amp;action=update&amp;id=<?php echo $_smarty_tpl->tpl_vars['shopping']->value['id'];?>
">Изменить</a></td>
					<td><a href="?model=shopping&amp;id=<?php echo $_smarty_tpl->tpl_vars['shopping']->value['id'];?>
&amp;parent_id=<?php echo $_smarty_tpl->tpl_vars['shopping']->value['parent_id'];?>
