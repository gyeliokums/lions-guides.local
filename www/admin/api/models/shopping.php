...
namespace API\Models {
	class Shopping extends AbstractModel {
		static protected
			$_basicTableName = 'shopping',
			$_innerKeys = array(
				'parent_id',
				'inner_name',
				'title',
		...
		protected function _createPathToUploads() {
			$data = \API\Data\Collector::instance();
			$ptui = '../uploads/images/stateunion/' . $data->get('country', 'position') . '/country/' . $data->get('city', 'position') . '/shopping/' . $data->get('id') . '/';
