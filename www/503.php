...
<head>
	<title>Путеводители и достопримечательности.| 503 Service Temporarily Unavailable</title>
	<meta charset="utf-8">
			...
			<div class="container">
				<div id="main">
					<div class="col-md-6 col-sm-9 no-float no-padding center-block">
						<div class="error-message">На сервере ведутся технические работы.</div>
						<div class="error-message-404">503</div>
						<div class="error-message">Приносим свои извинения за доставленные неудобства.</div>
					</div>
				</div>
			</div>
        </section>
